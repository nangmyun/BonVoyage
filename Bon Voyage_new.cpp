...
int SpaceShip::StartDay() {
	...
	for (int i = 0; i < 4; i++) { //배부름 감소, hp 회복 
		...
		if (p[i]->ShowState(2) <= 0) { //배고픔 0 이하 아사 
		   //아사 이벤트 출력 
			cout << ">>" << p[i]->ShowJob() << "은(는) 아사했습니다. 더욱 각별한 주의가 필요합니다.\n";
			for (int j = 0; j < 4; j++) {
...
int SpaceShip::choosePlanet() {
	...
	if (exploredPlanet >= 5 && r[1]->ShowLv() == 3) { //신 지구 생성 
		Planet p4("지구");
		planetList.push_back(p4);
		earth = 1;
	}
	else {
	...
	while (1) {
		...
		for (int i = 0; i < 3; i++) {
			...
			gotoxy(1 + i * 45, 6);
			if (sLv >= 3) cout << "획득 가능 자원량 | 에너지: " << it->ShowIntState(3) << "lv 음식: " << it->ShowIntState(4) << "lv";
...
void SpaceShip::DecideToExplore() {//행성 도착 후 탐사 할지 말지 정하기
	...
	if (it->ShowIntState(3) == 999) PrintEnding(3); //신 지구 발견 엔딩 
	srand(time(NULL));
	if (rand() % 2 == 0) PlanetUI1();
	else PlanetUI2();

	cout << ">>행성에 도착했습니다.\n";
	cout << ">>에너지 자원과 음식 자원을 얻었습니다.\n\n";
	cout << "  에너지 자원 " << it->ShowIntState(3) * 500 << ", 음식 자원 " << it->ShowIntState(4) * 50 << "획득";
	energy += it->ShowIntState(3) * 500;
	food += it->ShowIntState(4) * 50;
	_getch();
...
void SpaceShip::GoodEvent() {
	...
	plus_hp = rand() % 10 + 1;
	plus_mental = rand() % 10 + 1;
	plus_food = rand() % 21 + 10;
	plus_energy = rand() % 501 + 300;
	food += plus_food;
	energy += plus_energy;
	cout << "\n\n\n\n\n\n\n\n\n\n";
	cout << "          행성 탐사 진행 시작\n";
	cout << "          자원 탐지기 및 이상 현상 탐지기 가동\n";
	Sleep(1000);
	cout << "          .\n";
	Sleep(1000);
	cout << "          .\n";
...
void SpaceShip::BadEvent() {
	...
	if (rand() % 3 == 0) {
		srand(time(NULL));
		minus_hp = rand() % 10 + 1;
		minus_full = rand() % 10 + 1;
		minus_mental = rand() % 10 + 1;
		cout << "\n\n\n\n\n\n\n\n\n\n";
		cout << "          행성 탐사 진행 시작\n";
		cout << "          자원 탐지기 및 이상 현상 탐지기 가동\n";
		Sleep(1000);
...
void startscript() {
	...
	cout << "\n\n\n\n\n\n\n\n\n\n        >>서기 xxxx년, 지구는 멸망했고,\n";
	Sleep(2000);
	cout << "          인류의 멸종을 막기 위해 새로운 지구를 찾아 떠나는 프로젝트가 시도된다.\n\n";
	Sleep(2000);
	cout << "          보이저 프로젝트는, 탐사선 보이저 호에 4명의 탐사대원을 냉동수면 상태로 전환,\n";
	Sleep(2000);
	cout << "          지구와 유사한 행성을 찾을 때까지 무기한 탐사에 돌입하는 계획이다.\n\n";
	Sleep(2000);
	cout << "        >>현재 외계은하 진입에 성공, 순조로운 항해가 이어질 것으로...\n";
	Sleep(3500);

	system("cls");
	cout << "warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning\n\n";
	Sleep(50);
	cout << " warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warnin\n\n";
	Sleep(50);
	cout << "  warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warni\n\n";
	Sleep(50);
	cout << "   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warn\n\n";
	Sleep(50);
	cout << "    warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   war\n\n";
	Sleep(50);
	cout << "     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   wa\n\n";
	Sleep(50);
	cout << "g     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   w\n\n";
	Sleep(50);
	cout << "ng     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   \n\n";
	Sleep(50);
	cout << "ing     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning  \n\n";
	Sleep(50);
	cout << "ning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning \n\n";
	Sleep(50);
	cout << "rning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning\n\n";
	Sleep(50);
	cout << "arning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warnin\n\n";
	Sleep(50);
	cout << "warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warni\n\n";
	Sleep(50);
	cout << " warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warni\n\n";
	...
	cout << "    warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   wa\n\n";
	Sleep(50);
	cout << "     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   w\n\n";
	Sleep(50);
	cout << "g     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   \n\n";
	Sleep(50);
	cout << "ng     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning  \n\n";
	Sleep(50);
	cout << "ing     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning \n\n";
	...
	cout << "ning     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning\n\n";
	Sleep(50);
	cout << "rning     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warnin\n\n";
	Sleep(50);
	cout << "arning     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warni\n\n";
	Sleep(50);
	cout << "warning     warning     warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warning   warn\n\n";
	Sleep(2000);
	system("cls");
	...
	cout << ".\n\n";
	Sleep(2000);
	cout << "          예측 궤도를 이탈한 소행성과의 접촉 사고로 판명.\n\n";
	Sleep(2000);
	...
	cout << "          섹터 a-2 파괴, 자동 자원 수급 장치 고장. 손실률 82%\n\n";
	Sleep(2000);
	cout << "          자동 수복 불가능.\n\n";
	Sleep(2000);
	cout << "          비상 사태 발생 매뉴얼에 따라 냉동수면 중지. 탐사대원의 상태를 전환합니다.\n\n";
	Sleep(2000);

	//튜토리얼 
	system("cls");
	cout << "\n\n\n\n\n\n\n\n\n\n          게임이 시작되면 먼저 현재 탐사선과 탐사원의 정보, 현재 소유 에너지와 식량 정보를 확인할 수 있습니다.\n";
	cout << "          이를 통해 앞으로의 행동을 계획적으로 플레이 가능합니다.\n\n";
	cout << "          정보 확인을 마쳤다면, 기체 업그레이드 파트로 넘어갑니다.\n";
	cout << "          일정 에너지를 소모해 기체 업그레이드 가능하며, 기체가 업그레이드 되면 각 연관 파트에서의 효율이 상승합니다.\n\n";
	cout << "          이후 식량 배분 파트 차례가 되면, 현재 탐사원들의 배고픔 수치가 제공됩니다. \n";
	cout << "          소유 식량을 배분해 배고픔 수치를 채워줄 수 있습니다.\n\n";
	_getch();
	system("cls");
	cout << "\n\n\n\n\n\n\n\n\n\n          탐사 과정을 설명하겠습니다.\n\n";
	cout << "          탐사할 행성이 선택되지 않은 상태라면, 주변의 가까운 행성 3가지 리스트가 제공됩니다.\n";
	cout << "          가스행성은 탐사 불가능한 행성이며, 암석행성만 탐사 가능합니다.\n\n";
	cout << "          리스트에서 암석행성이 없다면 선택하지 않음을 통해 일정 에너지를 소비하고,\n";
	cout << "          새로운 리스트를 얻을 수 있습니다.\n\n";
	_getch();
	system("cls");
	cout << "\n\n\n\n\n\n\n\n\n\n          탐사할 행성이 선택되었다면, 이동 기간동안 대화 상태가 활성화됩니다.\n\n";
	cout << "          하루에 한 번, 원하는 탐사원과 대화를 할 수 있으며,\n";
	cout << "          대화의 대답을 통해 해당 탐사원의 멘탈을 회복시킬수도, 깎을 수도 있습니다.\n\n";
	_getch();
	system("cls");
	cout << "\n\n\n\n\n\n\n\n\n\n          이동이 끝나고 행성에 도착하면, 행성을 탐사할 수 있고, 탐사에 참정할 탐사원을 선택할 수 있습니다.\n\n";
	cout << "          탐사를 시작하면 랜덤으로 이벤트가 발생하며, 탐사원의 스탯을 올릴수도 내릴수도 있습니다.\n";
	_getch();
	system("cls");
	cout << "\n\n\n\n\n\n\n\n\n\n          이를 반복해 오래 살아남으며 신지구를 발견하면 목표 달성입니다.\n";
	_getch();
}
